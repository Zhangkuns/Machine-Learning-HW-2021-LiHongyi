...
train = np.load('data2022/trainingset.npy', allow_pickle=True)
test = np.load('data2022/testingset.npy', allow_pickle=True)
...
# Module for obtaining and processing data.
